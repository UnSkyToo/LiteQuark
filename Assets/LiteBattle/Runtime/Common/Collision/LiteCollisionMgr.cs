    ...
    public sealed class LiteCollisionMgr : Singleton<LiteCollisionMgr>
    {
        ...
        public List<LiteEntity> CheckCollide(LiteEntity owner, ILiteRange range, LiteEntityCamp camp)
        {
            ...
            for (var i = 0; i < count; ++i)
            {
                ...
                if (collider != null)
                {
                    var entity = LiteEntityMgr.Instance.GetEntity(collider.EntityUniqueID);
