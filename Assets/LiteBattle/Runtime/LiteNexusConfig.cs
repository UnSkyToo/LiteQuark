...
namespace LiteBattle.Runtime
{
    public class LiteNexusConfig : ScriptableObject
    {
        ...
        private static AssetHandle<LiteNexusConfig> InstanceHandle_;
...
#else
                    InstanceHandle_ = LiteRuntime.Asset.LoadAssetHandle<LiteNexusConfig>(ConfigName);
                    Instance_ = InstanceHandle_.Task.GetAwaiter().GetResult();
#endif
                }
