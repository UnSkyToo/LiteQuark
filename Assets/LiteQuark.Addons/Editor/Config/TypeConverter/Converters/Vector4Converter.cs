...
{
    internal sealed class Vector4Converter : ITypeConverter
    {
        public ConfigFieldType FieldType => ConfigFieldType.Vector4;

        public bool CanConvert(string typeRaw) => typeRaw == "vector4";

        public object Convert(string value)
        {
            if (string.IsNullOrEmpty(value)) return new float[] { 0f, 0f, 0f, 0f };
            ...
            return new float[]
            {
                ...
                parts.Length > 3 ? float.Parse(parts[3].Trim(), CultureInfo.InvariantCulture) : 0f,
            };
        }
        ...
        public void WriteJson(LitJson.JsonWriter writer, object value)
        {
            ...
            writer.WritePropertyName("w"); writer.Write((double)arr[3]);
